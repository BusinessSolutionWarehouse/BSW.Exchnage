	...
	public partial class TariffBookController : List<TariffBookModel>, IController
	{
		...
		public bool Insert(TariffBookModel model, ref string msg)
		{
			...
			try
			{
                ...
                listParameters.Add(ControllerManager.CreateParameter("@SADCDuty", model.SADCDuty, SqlDbType.Decimal));
                listParameters.Add(ControllerManager.CreateParameter("@EUDuty", model.EUDuty, SqlDbType.Decimal));
                listParameters.Add(ControllerManager.CreateParameter("@GenDuty", model.GenDuty, SqlDbType.Decimal));
                listParameters.Add(ControllerManager.CreateParameter("@EFTADuty", model.EFTADuty, SqlDbType.Decimal));
		...
		public bool Update(TariffBookModel model, bool dynamicUpdate, ref string msg)
		{
			...
			try
			{
				...
				if (dynamicUpdate)
				{
                    ...
                    if (model.SADCDuty.HasValue)
                        listParameters.Add(ControllerManager.CreateParameter("@SADCDuty", model.SADCDuty, SqlDbType.Decimal));

                    if (model.EUDuty.HasValue)
                        listParameters.Add(ControllerManager.CreateParameter("@EUDuty", model.EUDuty, SqlDbType.Decimal));

                    if (model.GenDuty.HasValue)
                        listParameters.Add(ControllerManager.CreateParameter("@GenDuty", model.GenDuty, SqlDbType.Decimal));

                    if (model.EFTADuty.HasValue)
                        listParameters.Add(ControllerManager.CreateParameter("@EFTADuty", model.EFTADuty, SqlDbType.Decimal));
