...
{
	public partial class TariffBookAuditController : List<TariffBookAuditModel>, IController
	{
		public bool Get(TariffBookAuditModel model, ref string msg)
		{
			return Get(model, null, null, ref msg);
		}

		public bool Get(TariffBookAuditModel model, TariffBookAuditModel.Fields? sortByField, SortOrder? sortOrder, ref string msg)
		{
			bool result = true;
			...
			try
			{
				...
				if (!string.IsNullOrEmpty(model.Action))
					listParameters.Add(ControllerManager.CreateParameter("@Action", model.Action, SqlDbType.Char));

				if (model.ActionDate.HasValue)
					listParameters.Add(ControllerManager.CreateParameter("@ActionDate", model.ActionDate.Value, SqlDbType.DateTime));

				if (model.ActionUserID.HasValue)
					listParameters.Add(ControllerManager.CreateParameter("@ActionUserID", model.ActionUserID.Value, SqlDbType.SmallInt));
				...
				if (model.TariffBookAuditID.HasValue)
					listParameters.Add(ControllerManager.CreateParameter("@TariffBookAuditID", model.TariffBookAuditID.Value, SqlDbType.Int));
				...
				result = ControllerManager.ExecuteSP("TariffBookAuditGet", listParameters, this, ref msg);
			}
			catch (Exception ex)
			{
				msg = ex.Message;
		...
		public bool Insert(TariffBookAuditModel model, ref string msg)
		{
			bool result = true;
			...
			try
			{
				...
				listParameters.Add(ControllerManager.CreateParameter("@Action", model.Action, SqlDbType.Char));
				listParameters.Add(ControllerManager.CreateParameter("@ActionDate", model.ActionDate, SqlDbType.DateTime));
				listParameters.Add(ControllerManager.CreateParameter("@ActionUserID", model.ActionUserID, SqlDbType.SmallInt));
				...
				result = ControllerManager.ExecuteSPScalar("TariffBookAuditInsert", listParameters, ref value, ref msg);

				if (result)
					model.TariffBookAuditID = ControllerManager.Converter.ToInt32(value);
			}
			catch (Exception ex)
			{
				msg = ex.Message;
		...
		public bool Update(TariffBookAuditModel model, bool dynamicUpdate, ref string msg)
		{
			bool result = true;
			...
			try
			{
				...
				result = ControllerManager.ExecuteSP("TariffBookAuditUpdate", listParameters, ref msg);
			}
			catch (Exception ex)
			{
				msg = ex.Message;
		...
		public bool Delete(TariffBookAuditModel model, ref string msg)
		{
			bool result = true;
			...
			try
			{
				...
				result = ControllerManager.ExecuteSP("TariffBookAuditDelete", listParameters, ref msg);
			}
			catch (Exception ex)
			{
				msg = ex.Message;
		...
		public bool ReadModelData(SqlDataReader reader, ref string msg)
		{
			try
			{
				TariffBookAuditModel model = new TariffBookAuditModel();

				model.Action = ControllerManager.Converter.ToString(reader["Action"]);
				model.ActionDate = ControllerManager.Converter.ToDateTime(reader["ActionDate"]);
				model.ActionUserID = ControllerManager.Converter.ToInt16(reader["ActionUserID"]);
				...
				model.TariffBookAuditID = ControllerManager.Converter.ToInt32(reader["TariffBookAuditID"]);
